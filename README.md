...
The [bitmagnet integration guide](docs/bitmagnet.md) and its [backup and restore guide](docs/bitmagnet-backup.md) document a self-hosted DHT indexer setup used during early development. Both are **archived** (2026-09-21) and no longer maintained; the guides remain readable for reference.
